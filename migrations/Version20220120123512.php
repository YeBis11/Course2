 ...
 */
final class Version20220120123512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_F7CCD7F171179CD6');
        $this->addSql('CREATE TEMPORARY TABLE __temp__collection_category AS SELECT id FROM collection_category');
        $this->addSql('DROP TABLE collection_category');
        $this->addSql('CREATE TABLE collection_category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO collection_category (id) SELECT id FROM __temp__collection_category');
        $this->addSql('DROP TABLE __temp__collection_category');
