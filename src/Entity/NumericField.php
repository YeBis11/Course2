...
use App\Repository\NumericFieldRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: NumericFieldRepository::class)]
class NumericField
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: Item::class, inversedBy: 'numericFields')]
